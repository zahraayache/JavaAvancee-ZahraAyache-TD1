...
public class Circle {
	...
	public static void main(String[] args) {
		...
		// to resolve this we change getCenter that will return a copy of the variable and not the variable itself
		c=new Circle(new Point(5,2), 1);
	...
	public Point getCenter() {
		Point variableIntermediaire = this.center;
		return variableIntermediaire;
	}
